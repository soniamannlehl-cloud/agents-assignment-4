"""
Database Setup for Customer Support System (GIVEN - fully implemented)

Creates a SQLite database with customers and tickets tables,
populated with 15 sample customers and 25 sample tickets.
...
class DatabaseSetup:
    ...
    def run_sample_queries(self):
        ...
        # Query 2: Ticket Statistics by Status
        print("\n2. Ticket Statistics by Status:")
        print("-" * 60)
        self.cursor.execute("""
        ...
        # Query 3: Ticket Statistics by Priority
        print("\n3. Ticket Statistics by Priority:")
        print("-" * 60)
        self.cursor.execute("""
